...
function filter_translations_render_navbar_output(\renderer_base $renderer) {
    ...
    $glossaryurl = new moodle_url("/filter/translations/manageglossary.php");
    ...
    return $renderer->render_from_template('filter_translations/toggleinlinestranslationstate', (object)[
        ...
        'glossaryurl' => $glossaryurl->out(false),
...
/////////////////////////////////
// eledia start – 2025041402001362  | added mapping for correct deepl-chinese translation
/**
 * Mappt Moodle Sprachcodes (z.B. zh_cn) auf die von DeepL erwarteten
 * Zielsprachen (z.B. ZH-HANS).
 *
 * @param string $moodlecode  Sprachcode aus Moodle (lower/upper egal).
 * @return string             DeepL-Code, immer UPPERCASE.
 */
function filter_translations_map_to_deepl(string $moodlecode): string {
    static $map = [
        // Chinesisch.
        'zh_cn'   => 'ZH-HANS',
        'zh_hans' => 'ZH-HANS',
    ...
    $moodlecode = strtolower($moodlecode);
    return $map[$moodlecode] ?? strtoupper($moodlecode);
}
// eledia end
///////////////////////////////
