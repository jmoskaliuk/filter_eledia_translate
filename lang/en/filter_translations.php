...
$string['any'] = 'Any';
$string['approvetranslation'] = 'Approve translation';
...
$string['languagepair'] = 'Language pair';
...
$string['managetranslationissues'] = 'Manage problems';
...
$string['navglossary'] = 'Glossary';
$string['navdashboard'] = 'Dashboard';
$string['navproblems'] = 'Problems';
$string['navsetup'] = 'Settings';
...
$string['onboardingstart_button'] = 'Start setup';
$string['onboardingstart_desc'] = 'Start setting up Ai Translate and use the wizard to guide you through the configuration.';
$string['onboardingstart_title'] = 'Set up Ai Translate';
...
$string['settingsstatus_check'] = 'Check';
$string['settingsstatus_ready'] = 'Ready';
...
$string['sourcelanguage_short'] = 'Source';
...
$string['targetlanguage_short'] = 'Target';
...
$string['translationsource'] = 'Source';
$string['translationsource_automatic'] = 'Automatic';
$string['translationsource_manual'] = 'Manual';
...
$string['translationissues'] = 'Problems';
...
$string['deepltest_confirm_button'] = 'Run DeepL test';
$string['deepltest_confirm_desc'] = 'Run a connection test with the configured DeepL settings. No translations are saved during the test.';
...
$string['glossarygroups'] = 'Glossary groups';
$string['hash'] = 'Hash';
...
$string['setupcoursefields_confirm_button'] = 'Create fields';
$string['setupcoursefields_confirm_desc'] = 'Create or update the recommended course custom fields for enabling Ai Translate and selecting target languages.';
