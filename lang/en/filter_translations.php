...
$string['coursecontrol_desc'] = 'Controls whether courses are translated from legacy course tags or Moodle course custom fields.';
...
$string['coursecontrolsource_desc'] = 'Choose where the filter reads course-level translation settings from. Legacy tags preserve the current behaviour. Course custom fields use Moodle course settings.';
...
$string['coursefieldlanguages_desc'] = 'Shortname of a Moodle course custom field containing allowed Moodle language codes, separated by commas, spaces, semicolons, pipes, or new lines. Leave empty on a course to allow all languages when translation is enabled. Default: eledia_translate_languages.';
$string['coursefieldlanguages_field_desc'] = 'Allowed Moodle target language codes for this course, for example: de, fr, es. Leave empty to allow all languages when translation is enabled.';
...
$string['deepl_glossaryid_desc'] = 'Optional DeepL glossary ID. DeepL requires a source language when a glossary is used. If no source language is configured, the site default language is used.';
